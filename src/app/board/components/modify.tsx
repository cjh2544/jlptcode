                  ...
                  <form onSubmit={onSubmit} className="space-y-4 md:space-y-6">
                      <div>
                          ...
                          <input
                            ...
                            required={true} maxLength={100} type="text" name="title" id="title" className="border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="제목 입력" />
