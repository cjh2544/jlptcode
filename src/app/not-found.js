                ...
                <div className="flex flex-col items-center justify-center px-6 py-8 max-w-md md:h-screen lg:py-0">
                    ...
                    <div className="w-full bg-white rounded-lg shadow-lg p-3">
                        <div class="text-center">
                            ...
                            <h1 class="mt-4 text-xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">{t('common.notFound')}</h1>
                            <div class="mt-10 flex items-center justify-center gap-x-6">
                                <a href="/" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">{t('common.goHome')}</a>
                            </div>
                        </div>
                    </div>
                </div>
