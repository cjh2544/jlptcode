  ...
  return (
    <>
      <div className="grid grid-cols-4 gap-4 sm:grid-cols-2">
        ...
        <button onClick={handleClick({part: 'part6'})} className="bg-lightBlue-500 text-white active:bg-lightBlue-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">
          PART6<br/>공란메우기
        </button>
