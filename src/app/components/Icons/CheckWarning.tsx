export default function CheckWarningIcon() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="pointer-events-none absolute left-1/2 top-0 h-12 w-12 -translate-x-1/2 -translate-y-1/2 fill-orange-500"
      viewBox="0 0 60 60"
      aria-hidden
    >
