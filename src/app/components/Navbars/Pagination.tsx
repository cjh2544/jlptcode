      ...
      <div className='px-4 mb-4'>
        <nav className="block">
          <ResponsivePagination
            ...
            pageLinkClassName='first:ml-0 text-xs font-semibold flex w-8 h-8 mx-1 p-0 rounded-full items-center justify-center leading-tight relative border border-solid border-light-blue-500 bg-white text-light-blue-500'
