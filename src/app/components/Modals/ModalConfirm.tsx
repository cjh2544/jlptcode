...
const ModalConfirm = (props: ModalConfirmProps) => {
  const {title, message, visible=false, onClose} = props;
          ...
          <div className="w-full max-w-md bg-white shadow-lg rounded-lg p-6 relative mx-auto text-center">
              ...
              <div className="mt-12">
                  ...
                  <button onClick={() => handleClose()} type="button"
                      className="px-6 py-2.5 mt-8 w-full rounded-md text-white text-sm font-semibold tracking-wide border-none outline-none bg-green-500 hover:bg-green-600">확인</button>
              </div>
          </div>
      </div>
    </>
