              ...
              <div className="w-full bg-white rounded-lg shadow-lg dark:border sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                  <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                      ...
                      <form onSubmit={onSubmit} className="space-y-4 md:space-y-6">
                          ...
                          <div>
                              <label className={`block mb-2 text-sm font-bold ${isValid('password') ? 'text-gray-900' : 'text-red-600'} dark:text-white`}>{t('auth.password')}</label>
                          ...
                          <div>
                              <label className={`block mb-2 text-sm font-bold ${isValid('confirm-password') ? 'text-gray-900' : 'text-red-600'} dark:text-white`}>{t('auth.confirmPassword')}</label>
