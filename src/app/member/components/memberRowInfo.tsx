                        ...
                        <form onSubmit={onSubmit}>
                          ...
                          <div className="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b">
                            {isLoading ? (
                              ...
                              <>
                                <button data-modal-hide="default-modal" type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">{t('member.apply')}</button>
                              </>
                            )}
