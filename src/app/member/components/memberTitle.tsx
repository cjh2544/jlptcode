...
const MemberTitle = (props: HeaderSubTitleProps) => {
  ...
  const {title, visibleButton = false, buttonTitle = t('board.write')} = props;
                ...
                <form onSubmit={onSubmit}>   
                  <div className="min-w-[200px]">
                    <div className="relative flex items-center">
                      ...
                      {isLoading ? (
                        <>
                          <button disabled type="button" className="cursor-not-allowed w-1/2 text-xs bg-green-300 text-white font-bold py-2 px-4 rounded focus:outline-hidden ml-1">
                        ...
                        <>
                          <button
                            className="hover:bg-green-700 border border-green-500 focus:outline-hidden text-xs bg-green-500 text-white font-bold py-2 px-4 rounded ml-1"
                            type="submit"
                          >
                            {t('common.search')}
                          </button> 
